...
\draw[thick, |-|] (2, 2) -- (2.3, 2) node [above, right, rotate=60, text width=2cm]{sensitive instruction};
...
\draw[thick, |-|] (5, 2) -- (5.3, 2) node [above, right, rotate=60, text width=2cm]{sensitive instruction};
