...
\begin{center}
\begin{tikzpicture}  [
						my brace/.style={thick, decorate, decoration={brace, amplitude=1pt, raise=10pt,},},							
						my label/.style={below right, align=center, rotate=90, inner ysep=14pt, },
						another label/.style={below right, align=center, rotate=90, inner ysep=3pt, },
					]
	...
	\addplot [fill=ForestGreen!60, xshift=\xShiftLatency, postaction={pattern=crosshatch dots}, pattern color=gray] coordinates {
				  ...
				  \draw [thick, |-|] ([xshift=14pt]a1) -- ([xshift=14pt]b1) node [another label] {\small{$-0.8\%$}};
				  \draw [thick, |-|] ([xshift=14pt]a2) -- ([xshift=14pt]b2) node [another label] {\small{$+9.5\%$}};
				  \draw [thick, |-|] ([xshift=14pt]a3) -- ([xshift=14pt]b3) node [another label] {\small{$+2.6\%$}};
				  \draw [thick, |-|] ([xshift=14pt]a4) -- ([xshift=14pt]b4) node [another label] {\small{$+2.7\%$}};
				  \draw [my brace] (a5) -- (b5) node [my label] {\small{$+12.2\%$}};
	\legend{native, shared TLB, isolated TLB}
	\end{axis}
...
%%%%%%%%%%%%%%%%%%%%%ENDIF%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\begin{axis} [	 name=plot2, \atCmdLowerPlot, 
					height=\figheight, width=\figwidth, enlarge y limits={upper,value=0.01},  
