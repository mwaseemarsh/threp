...
\node at (0,2) [rectangle, draw=black, thick, rounded corners,  minimum height = 1cm, minimum width = 2cm, anchor=south west] (b1) {};
...
\node at (2,2) [rectangle, draw=black, thick, rounded corners,  minimum height = 1cm, minimum width = 2cm, anchor=south west] (b2) {};
\begin {scope} [opacity=0.6]
...
\node at (4,2) [rectangle, draw=black, thick, rounded corners,  minimum height = 1cm, minimum width = 2cm, anchor=south west] (b2) {};
\begin {scope} [opacity=0.6]
...
\node at (0,1) [rectangle, draw=black, thick, rounded corners,  minimum height = 0.5cm, minimum width = 6cm, anchor=south west] (tr) {translator};
